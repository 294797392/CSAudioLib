...
{
    public class KMFileStream : IGMusicStream
    {
        private static log4net.ILog logger = log4net.LogManager.GetLogger("KMFileStream");

        private FileStream stream;

        public KMFileStream(MusicSource source) : base(source)
        {
        }

        public override MusicStreamType StreamType
        {
            get
            {
                return MusicStreamType.File;
            }
        }
