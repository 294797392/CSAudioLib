...
namespace CSAudioLib.DirectSound
{
    ...
    public interface IDirectSoundBuffer8
    {
        ...
        [PreserveSig]
        uint GetFormat(out tWAVEFORMATEX pwfxFormat, uint dwSizeAllocated, out uint pdwSizeWritten);
        ...
        [PreserveSig]
        uint Initialize(IntPtr pDirectSound, ref _DSBUFFERDESC pcDSBufferDesc);
        ...
        [PreserveSig]
        uint SetFormat(ref tWAVEFORMATEX pcfxFormat);
        ...
        [PreserveSig]
        uint SetFX(uint dwEffectsCount, _DSEFFECTDESC pDSFXDesc, out uint pdwResultCodes);
