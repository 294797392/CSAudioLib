...
namespace CSAudioLib.DirectSound
{
    ...
    public interface IDirectSoundCaptureBuffer8
    {
        ...
        /// <returns></returns>
        [PreserveSig]
        uint GetCurrentPosition(out int pdwCapturePosition, out int pdwReadPosition);
        ...
        [PreserveSig]
        uint Initialize(IntPtr pDirectSoundCapture, ref _DSCBUFFERDESC pcDSCBufferDesc);
